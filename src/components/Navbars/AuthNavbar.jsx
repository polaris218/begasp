              ...
              <Nav className="align-items-lg-center ml-lg-auto" navbar>
                <NavItem>
                  <NavLink
                    ...
                    href="https://www.youtube.com/begasp/"
                    id="tooltip601201423"
                    target="_blank"
                  >
                ...
                <NavItem>
                  <NavLink
                    className="nav-link-icon"
                    href="https://www.twitch.com/begasp/"
                    id="tooltip601201423"
                    target="_blank"
                  >
                ...
                <NavItem>
                  <NavLink
                    className="nav-link-icon"
                    href="https://www.facebook.com/begasp/"
                    id="tooltip601201423"
                    target="_blank"
                  >
                ...
                <NavItem>
                  <NavLink
                    className="nav-link-icon"
                    href="https://www.instagram.com/begaspinc/"
                    id="tooltip871243015"
                    target="_blank"
                  >
                ...
                <NavItem>
                  <NavLink
                    className="nav-link-icon"
                    href="https://twitter.com/begaspinc"
                    id="tooltip366258619"
                    target="_blank"
                  >
                ...
                <NavItem>
                  <NavLink
                    className="nav-link-icon"
                    href="https://github.com/tkntobfrk"
                    id="tooltip931502898"
                    target="_blank"
                  >
                ...
                <NavItem className="d-none d-lg-block ml-lg-4">
                  <Button
                    ...
                    color="default"
                    href="https://wip.BeGasp.com"
                    target="_blank"
                  >
                    <span className="btn-inner--icon">
                      <i className="fas fa-shopping-cart mr-2" />
                    </span>
                    <span className="nav-link-inner--text">Download now</span>
                  </Button>
                </NavItem>
              </Nav>
            </UncontrolledCollapse>
